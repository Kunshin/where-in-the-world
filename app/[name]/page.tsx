            ...
            <main>
                ...
                <div className="flex flex-col md:flex-row md:justify-between px-8 md:px-14 mb-10">
                    {country && (<>
                        ...
                        <section className="flex flex-col md:w-1/2 md:justify-center">
                            ...
                            <div className="mt-4">
                                ...
                                <div className="flex flex-wrap gap-4 mt-4">
                                    {borderCountries.map((c: any, i: number) => {
                                        return <button className="rounded-md w-[120px] h-[36px] text-sm bg-white dark:bg-dark-blue shadow-lg outline outline-black/5 inline-flex items-center justify-center gap-2" type="button" onClick={() => router.replace(`/${c.name?.common.toLowerCase()}`)} key={i}>{c.name?.common}</button>
                                    })}
                                </div>
                            </div>
                        </section>
